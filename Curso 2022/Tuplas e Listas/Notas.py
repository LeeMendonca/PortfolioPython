'''
A professora de PI (Processamento da Informação) armazena as notas de uma aluna em uma lista. Você consegue escrever um algoritmo que calcula a média das notas?
'''
